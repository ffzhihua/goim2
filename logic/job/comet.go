...
// user push 循环选择一个MPushMsgArg channel，将消息推送至该信道
...
// room push 按照房间推送，循环选择一个BoardcastRoomArg Channel，将消息推送至该信道
...
// broadcast 广播，循环选择一个BoardcastArg Channe，将消息推送至该信道
...
// process IO复用协程，作为pushChan，roomChan，broadcastChan信道的消费者，消费完后，转发comet service
